    ...
    internal static class RibbonLayout
    {
        ...
        public static readonly IReadOnlyList<RibbonPanelSpec> Panels = new[]
        {
            new RibbonPanelSpec("App & Data Import", new RibbonEntry[]
            {
                ...
                new RibbonButtonSpec("SetSunAndLocation", "Set Sun +\nLocation", "SetSunAndLocationCommand", "Sets this project's real Site Location and Sun Settings from the web app's Site tab data.", "sun"),
            ...
            new RibbonPanelSpec("Simulation & Analytics", new RibbonEntry[]
            {
                ...
                new RibbonPulldownSpec("PullEnvironmental", "Environmental", "Sun, wind and rain on the roof garden. A physical analysis: it runs in Unity, or gives its charts as a PDF.", "sun", new[]
                {
            ...
            new RibbonPanelSpec("BIM & Documentation", new RibbonEntry[]
            {
                ...
                {
                    new RibbonButtonSpec("AssignPhasing", "Batch Assign Phasing", "AssignPhasingCommand", "Puts every Sportify element of this project (what the last import created) into the phase you choose (Phase Created).", "phasing"),
                    new RibbonButtonSpec("AssignWorksets", "Organize Multi-Worksets", "AssignWorksetsCommand", "Puts every Sportify element of this project on its own workset: courts and equipment on Sports, planting and ground on Gardens, boundaries, paths and entries on Combine. Needs a workshared project.", "worksets"),
                }),
            }),
