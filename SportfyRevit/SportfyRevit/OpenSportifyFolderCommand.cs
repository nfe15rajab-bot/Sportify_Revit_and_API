...
{
    /// <summary>
    /// Opens the Sportify folder (default Documents\Sportify, or the one chosen at install) in Explorer: the layouts, sport and garden data, the charts PDFs of the
