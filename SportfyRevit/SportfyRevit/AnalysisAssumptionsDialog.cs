...
namespace SportfyRevit
{
    ...
    ///
    /// The same choice is offered in the web app's Structure inputs and Site conditions tabs (assumptions.js); this dialog is for deciding at
        ...
        public AnalysisAssumptionsDialog(string title, IReadOnlyList<AssumptionRow> rows, string analysis)
        {
            ...
            var intro = new TextBlock
            {
                ...
                Text = "This analysis rests on a few values the layout cannot know. For each, enter your own value, or accept the built-in one knowingly. " +
                       ...
                       "Values entered here last for this Revit session; enter them in the app's Structure inputs and Site conditions tabs to keep them with the layout.",
            };
