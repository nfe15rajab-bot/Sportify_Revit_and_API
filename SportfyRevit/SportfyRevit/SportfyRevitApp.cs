    ...
    public class SportfyRevitApp : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            AddButton(unityAnalysisPanel, "AnalyzeStructuralResonance", "Structural\nResonance", typeof(AnalyzeStructuralResonanceCommand),
                "Placeholder — the dynamic half of the structural analysis: crowds moving through the day, and water, wind and snow acting on the roof, and the vibration this excites in the existing structure. Not built yet; Structural Loads is the static half.");
